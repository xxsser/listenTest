...
!function (e, t) {
    ...
    function x(e) {
        var t = J, n = Pt[e];
        return n || (n = b(e, t), "none" !== n && n || (Ot = (Ot || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ot[0].contentDocument, t.write(), t.close(), n = b(e, t), Ot.detach()), Pt[e] = n), n
    }
    ...
    function j(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)r = e[a], r.style && (o[a] = vt.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Tt(r) && (o[a] = vt.access(r, "olddisplay", x(r.nodeName)))) : (i = Tt(r), "none" === n && i || vt.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
    ...
    function L(e, t, n) {
        var r, i, o, a, s, u, l, c, f = this, d = {}, p = e.style, h = e.nodeType && Tt(e), m = vt.get(e, "fxshow");
    ...
    function F(e, t, n) {
        var r, i, o = 0, a = tn.length, s = Z.Deferred().always(function () {
            ...
            if (i)return !1;
            for (var t = Yt || A(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++)l.tweens[a].run(o);
        ...
        for (I(c, l.opts.specialEasing); a > o; o++)if (r = tn[o].call(l, e, c, l.opts))return r;
    ...
    function P(e, t, n, r) {
        ...
        }); else if (n || "object" !== Z.type(t))r(e, t); else for (i in t)P(e + "[" + i + "]", t[i], n, r)
    }
    ...
    var W = [], _ = W.slice, Q = W.concat, z = W.push, X = W.indexOf, U = {}, V = U.toString, G = U.hasOwnProperty, Y = {}, J = e.document, K = "2.1.4", Z = function (e, t) {
     ...
     */
        function (e) {
            function t(e, t, n, r) {
                ...
                if ((t ? t.ownerDocument || t : P) !== L && q(t), t = t || L, n = n || [], s = t.nodeType, "string" != typeof e || !e || 1 !== s && 9 !== s && 11 !== s)return n;
                if (!r && F) {
            ...
            function p(e, t, n) {
                ...
                return t.first ? function (t, n, o) {
                    ...
                    if (a) {
                        ...
                        if (u = t[O] || (t[O] = {}), (s = u[r]) && s[0] === B && s[1] === o)return l[2] = s[2];
            ...
            function b(e, n) {
                var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
                    var c, f, d, p = 0, h = "0", m = r && [], v = [], y = N, b = r || o && C.find.TAG("*", l), x = B += null == y ? 1 : Math.random() || .1, w = b.length;
                    ...
                    if (p += h, i && h !== p) {
                        ...
                        if (r) {
                            if (p > 0)for (; h--;)m[h] || v[h] || (v[h] = Y.call(u));
                            v = g(v)
                        }
            ...
            var x, w, C, T, k, S, E, j, N, A, D, q, L, I, F, H, R, $, M, O = "sizzle" + 1 * new Date, P = e.document, B = 0, W = 0, _ = n(), Q = n(), z = n(), X = function (e, t) {
                return e === t && (D = !0), 0
            }, U = 1 << 31, V = {}.hasOwnProperty, G = [], Y = G.pop, J = G.push, K = G.push, Z = G.slice, et = function (e, t) {
            ...
            w = t.support = {}, k = t.isXML = function (e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, I = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), F = !k(r), w.attributes = i(function (e) {
                ...
                })), (w.matchesSelector = vt.test($ = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && i(function (e) {
                    w.disconnectedMatch = $.call(e, "div"), $.call(e, "[s!='']:x"), R.push("!=", at)
                }), H = H.length && new RegExp(H.join("|")), R = R.length && new RegExp(R.join("|")), t = vt.test(I.compareDocumentPosition), M = t || vt.test(I.contains) ? function (e, t) {
                    ...
                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === P && M(P, e) ? -1 : t === r || t.ownerDocument === P && M(P, t) ? 1 : A ? et(A, e) - et(A, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t)return D = !0, 0;
                ...
                if ((e.ownerDocument || e) !== L && q(e), n = n.replace(ft, "='$1']"), !(!w.matchesSelector || !F || R && R.test(n) || H && H.test(n)))try {
                    var r = $.call(e, n);
                        ...
                        return 1 === r && 0 === i ? function (e) {
                            ...
                            if (g) {
                                ...
                                if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                    for (c = g[O] || (g[O] = {}), l = c[e] || [], p = l[0] === B && l[1], d = l[0] === B && l[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (d = p = 0) || h.pop();)if (1 === f.nodeType && ++d && f === t) {
                                        c[e] = [B, p, d];
                                        break
                                    }
                                } else if (y && (l = (t[O] || (t[O] = {}))[e]) && l[0] === B)d = l[1]; else for (; (f = ++p && f && f[m] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[O] || (f[O] = {}))[e] = [B, d]), f !== t)););
                                return d -= i, d === r || d % r === 0 && d / r >= 0
                            }
                        }
                    }, PSEUDO: function (e, n) {
                        var i, o = C.pseudos[e] || C.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
                        return o[O] ? o(n) : o.length > 1 ? (i = [e, e, "", n], C.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function (e, t) {
                ...
                pseudos: {
                    not: r(function (e) {
                        ...
                        return pt.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(wt, Ct).toLowerCase(), function (t) {
                            var n;
            ...
            return f.prototype = C.filters = C.pseudos, C.setFilters = new f, S = t.tokenize = function (e, n) {
                ...
                var n, r = [], i = [], o = z[e + " "];
                if (!o) {
                    for (t || (t = S(e)), n = t.length; n--;)o = y(t[n]), o[O] ? r.push(o) : i.push(o);
                ...
                if (n = n || [], 1 === f.length) {
                    if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && F && C.relative[o[1].type]) {
                        if (t = (C.find.ID(a.matches[0].replace(wt, Ct), t) || [])[0], !t)return n;
                        l && (t = t.parentNode), e = e.slice(o.shift().value.length)
                    }
                    for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !C.relative[s = a.type]);)if ((u = C.find[s]) && (r = u(a.matches[0].replace(wt, Ct), bt.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && d(o), !e)return K.apply(n, r), n;
                        break
                    }
                }
                return (l || E(e, f))(r, t, !F, n, bt.test(e) && c(t.parentNode) || t), n
            }, w.sortStable = O.split("").sort(X).join("") === O, w.detectDuplicates = !!D, q(), w.sortDetached = i(function (e) {
    ...
    var wt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ct = ["Top", "Right", "Bottom", "Left"], Tt = function (e, t) {
    ...
    var Et = /^key/, jt = /^(?:mouse|pointer|contextmenu)|click/, Nt = /^(?:focusinfocus|focusoutblur)$/, At = /^([^.]*)(?:\.(.+)|)$/;
    Z.event = {
        global: {},
        add: function (e, t, n, r, i) {
            ...
            }), t = (t || "").match(pt) || [""], l = t.length; l--;)s = At.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p && (f = Z.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = Z.event.special[p] || {}, c = Z.extend({
                type: p,
                origType: m,
                data: r,
                handler: n,
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (u = g.events)) {
                for (t = (t || "").match(pt) || [""], l = t.length; l--;)if (s = At.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function (t, n, r, i) {
            var o, a, s, u, l, c, f, d = [r || J], p = G.call(t, "type") ? t.type : t, h = G.call(t, "namespace") ? t.namespace.split(".") : [];
    ...
    }), Y.focusinBubbles || Z.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
    ...
    var Dt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, qt = /<([\w:]+)/, Lt = /<|&#?\w+;/, It = /<(?:script|style|link)/i, Ft = /checked\s*(?:[^=]|=\s*.checked.)/i, Ht = /^$|\/(?:java|ecma)script/i, Rt = /^true\/(.*)/, $t = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Mt = {
    ...
    Mt.optgroup = Mt.option, Mt.tbody = Mt.tfoot = Mt.colgroup = Mt.caption = Mt.thead, Mt.th = Mt.td, Z.extend({
        clone: function (e, t, n) {
            ...
            if (!(Y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || Z.isXMLDoc(e)))for (a = v(s), o = v(e), r = 0, i = o.length; i > r; r++)y(o[r], a[r]);
            ...
            for (var i, o, a, s, u, l, c = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++)if (i = e[d], i || 0 === i)if ("object" === Z.type(i))Z.merge(f, i.nodeType ? [i] : i); else if (Lt.test(i)) {
                for (o = o || c.appendChild(t.createElement("div")), a = (qt.exec(i) || ["", ""])[1].toLowerCase(), s = Mt[a] || Mt._default, o.innerHTML = s[1] + i.replace(Dt, "<$1></$2>") + s[2], l = s[0]; l--;)o = o.lastChild;
        ...
        text: function (e) {
            ...
            return gt(this, function (e) {
                ...
                if ("string" == typeof e && !It.test(e) && !Mt[(qt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Dt, "<$1></$2>");
                    try {
            ...
            if (m || l > 1 && "string" == typeof d && !Y.checkClone && Ft.test(d))return this.each(function (n) {
                var r = c.eq(n);
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)for (s = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++)a = i[u], Ht.test(a.type || "") && !vt.access(a, "globalEval") && Z.contains(s, a) && (a.src ? Z._evalUrl && Z._evalUrl(a.src) : Z.globalEval(a.textContent.replace($t, "")))
            }
            return this
        }
    }), Z.each({
    ...
    var Ot, Pt = {}, Bt = /^margin/, Wt = new RegExp("^(" + wt + ")(?!px)[a-z%]+$", "i"), _t = function (t) {
    ...
    var Qt = /^(none|table(?!-c[ea]).+)/, zt = new RegExp("^(" + wt + ")(.*)$", "i"), Xt = new RegExp("^([+-])=(" + wt + ")", "i"), Ut = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    Z.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = Z.cssProps[s] || (Z.cssProps[s] = T(u, s)), a = Z.cssHooks[t] || Z.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Xt.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[s] || (n += "px"), Y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n)), void 0)
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = Z.camelCase(t);
            return t = Z.cssProps[s] || (Z.cssProps[s] = T(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = w(e, t, r)), "normal" === i && t in Vt && (i = Vt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
        }
    }), Z.each(["height", "width"], function (e, t) {
        Z.cssHooks[t] = {
            get: function (e, n, r) {
                return n ? Qt.test(Z.css(e, "display")) && 0 === e.offsetWidth ? Z.swap(e, Ut, function () {
                    return E(e, t, r)
                }) : E(e, t, r) : void 0
            }, set: function (e, n, r) {
                var i = r && _t(e);
    ...
    var Yt, Jt, Kt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + wt + ")([a-z%]*)$", "i"), en = /queueHooks$/, tn = [L], nn = {
        "*": [function (e, t) {
    ...
    Z.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, u = 0 > i ? s : o ? i : 0; s > u; u++)if (n = r[u], !(!n.selected && u !== i || (Y.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
    ...
    var dn = /#.*$/, pn = /([?&])_=[^&]*/, hn = /^(.*?):[ \t]*([^\r\n]*)$/gm, mn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, gn = /^(?:GET|HEAD)$/, vn = /^\/\//, yn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, bn = {}, xn = {}, wn = "*/".concat("*"), Cn = e.location.href, Tn = yn.exec(Cn.toLowerCase()) || [];
    Z.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || Cn) + "").replace(dn, "").replace(vn, Tn[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(pt) || [""], null == f.crossDomain && (u = yn.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Tn[1] && u[2] === Tn[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Tn[3] || ("http:" === Tn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), R(bn, f, t, w), 2 === b)return w;
    ...
    var An = 0, Dn = {}, qn = {0: 200, 1223: 204}, Ln = Z.ajaxSettings.xhr();
    e.attachEvent && e.attachEvent("onunload", function () {
        ...
        return Y.cors || Ln && !e.crossDomain ? {
            send: function (n, r) {
                ...
                t = function (e) {
                    return function () {
                        t && (delete Dn[a], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(qn[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {text: o.responseText} : void 0, o.getAllResponseHeaders()))
                    }
    ...
    Z.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Fn, "$1" + i) : t.jsonp !== !1 && (t.url += (fn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            ...
            e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, In.push(i)), a && Z.isFunction(o) && o(a[0]), a = o = void 0
        }), "script") : void 0
    ...
    return Z.noConflict = function (t) {
        return e.$ === Z && (e.$ = Mn), t && e.jQuery === Z && (e.jQuery = $n), Z
    ...
    var e;
    e = "wechat-games-hearing_test-done", $(document).on("page:load#" + e, function () {
        var e, t, n, r;
        return e = $("#bar .filled"), e.width(e.data("percentage")), t = $(".container > .app_banner img"), r = function () {
            var e;
            return e = t.height() + "px", $(".container > .screen").css({"margin-bottom": "-" + e, "padding-bottom": e})
        }, t.on("load", r).each(function () {
            return this.complete ? r() : void 0
        }), /MicroMessenger/.test(navigator.userAgent) ? (n = $("#button-share"), n.attr("href", "javascript:;"), n.on("click", function () {
            return $(".mask").show(), "function" == typeof ga ? ga("send", "event", "Game", "ready_share", "Hearing") : void 0
        }), $(".mask .button").on("click", function () {
            return $(".mask").hide()
        }), "undefined" != typeof wx && null !== wx ? wx.ready(function () {
            return wx.onMenuShareTimeline({
                title: $("#button-share").data("title"),
                link: gon.moment_uri,
                imgUrl: gon.moment_icon,
                success: function () {
                    return location.href = $("#button-share").data("report")
                }
    ...
    var e;
    e = "wechat-games-hearing_test-play", $(document).on("page:load#" + e, function (e, t) {
        var n, r, i;
        return i = null, n = null, t.on("touchstart", function () {
            var e;
            return e = $("audio")[0], 4 !== e.readyState ? e.load() : void 0
        }), t.on("click", ".play-button", function () {
            var e, t, n;
            return n = $("audio")[0], 4 !== n.readyState ? void n.load() : (t = $(this), e = $("#audio"), t.toggleClass("playing").siblings().removeClass("playing"), t.hasClass("playing") && 1 * t.data("index") === r.currentRightIndex ? e[0].play() : e[0].pause(), clearTimeout(i), i = setTimeout(function () {
                return $(".play-button.playing").removeClass("playing")
            }, 1e3))
        }), t.find("audio").on("ended", function () {
            return $(".play-button.playing").removeClass("playing")
        }).on("loadstart", function () {
            return n = new Date, $(".play-button .btn").addClass("flip")
        }).on("canplaythrough", function () {
            var e;
            return e = new Date - n, setTimeout(function () {
                return $(".play-button .btn").removeClass("flip")
            }, Math.max(600 - e, 0))
        }), t.on("click", ".choices .button", function () {
            var e, t;
            return e = $(this), t = 1 * e.data("index"), r.saveAnswer(t), r.gotResult() ? $.ajax({
                url: $(".choices").data("url"),
                method: "patch",
                async: !1,
                data: {answers: JSON.stringify(r.answers), retried: JSON.stringify(r.retried), result: r.result()}
            }) : void r.next()
        }), r = {
            answers: [],
            retried: {},
            ...
            declaredIllistenableLowerContour: null,
            next: function () {
                var e, t, n;
                if (this.currentQuestionIndex = this.nextQuestionIndex(), this.currentQuestionIndex < 0 || this.currentQuestionIndex > this.questions.length - 1)throw"lost";
                return this.currentQuestion = this.questions[this.currentQuestionIndex], this.currentRightIndex = Math.floor(3 * Math.random()), e = $("audio"), t = e[0], e.attr("src", gon.audioPathes[this.currentQuestion]), t.load(), n = (this.currentQuestion - 9e3) / 12e3, $(".frequency .bar").width((100 * n).toFixed(2) + "%")
            },
            gotResult: function () {
                var e, t;
                return t = this.calculateListenableUpperContour(), e = this.calculateIllistenableLowerContour(), t && e || this.questions.length - t < 3 || 2 === e
            },
            result: function () {
                var e, t, n;
                return this.gotResult() ? (t = this.calculateListenableUpperContour(), e = this.calculateIllistenableLowerContour(), this.questions.length - t < 3 ? this.questions[t] : t + 1 === e ? this.questions[t] : 2 === e ? this.questions[0] : (n = this.questions.splice(t + 1, e - t - 1), n.reduce(function (e, t) {
                    return e + t
                }, 0) / n.length)) : !1
            },
            saveAnswer: function (e) {
                var t;
                return -1 === e && (this.declaredIllistenableLowerContour = this.currentQuestionIndex), t = e === this.currentRightIndex, -1 !== e && !t && !this.retried[this.currentQuestionIndex] && this.currentQuestion < this.retryThreshold ? void(this.retried[this.currentQuestionIndex] = 1) : this.setAnswerByQuestionIndex(this.currentQuestionIndex, t)
            },
            questions: [1e4, 11e3, 12e3, 13e3, 14e3, 14500, 15e3, 15500, 16e3, 16500, 16500, 17e3, 17500, 17500, 18e3, 18e3, 18500, 18500, 19e3, 19e3, 19500, 19500, 19750, 19750, 2e4, 2e4, 20250, 20250, 20500, 20500, 20750, 20750, 21e3, 21e3, 21e3],
            findAnswerByQuestionIndex: function (e) {
                var t, n, r, i;
                for (i = this.answers, n = 0, r = i.length; r > n; n++)if (t = i[n], t.index === e)return t;
                return null
            },
            sortedAnswers: function (e) {
                return null == e && (e = this.answers), e = e.slice(0), e.sort(function (e, t) {
                    return e.index > t.index ? 1 : e.index < t.index ? -1 : 0
                })
            },
            setAnswerByQuestionIndex: function (e, t) {
                var n, r, i, o;
                if (0 === e && !t)return void alert("\u7edd\u5927\u591a\u6570\u4eba\u80fd\u542c\u5230\u8fd9\u4e2a\u9891\u7387\u7684\u58f0\u97f3\uff0c\u8981\u4e0d\u8981\u68c0\u67e5\u4e00\u4e0b\u8033\u673a\u6216\u8005\u9759\u97f3\u6309\u94ae\uff1f");
                for (o = this.answers, r = 0, i = o.length; i > r; r++)if (n = o[r], n.index === e)return void(n.correct = t);
                return this.answers.push({index: e, correct: t})
            },
            nextQuestionIndex: function () {
                var e, t, n, r, i, o, a, s, u;
                if (0 === this.answers.length)return 0;
                if (1 === this.answers.length)return Math.floor(this.questions.length / 2);
                if (!this.findAnswerByQuestionIndex(this.questions.length - 1) && this.sortedAnswers().reverse()[0].correct)return this.questions.length - 1;
                if (!this.findAnswerByQuestionIndex(this.questions.length - 2) && this.findAnswerByQuestionIndex(this.questions.length - 1) && this.findAnswerByQuestionIndex(this.questions.length - 1).correct)return this.questions.length - 2;
                if (e = this.answers.filter(function (e) {
                        return e.correct
                    }), i = this.answers.filter(function (e) {
                        return !e.correct
                    }), t = (null != (s = this.sortedAnswers(e).reverse()[0]) ? s.index : void 0) || -1, a = (null != (u = this.sortedAnswers(i)[0]) ? u.index : void 0) || this.questions.length, a > t + 1)return Math.ceil((t + a) / 2);
                for (o = this.calculateListenableUpperContour(), r = this.calculateIllistenableLowerContour(), n = t; this.findAnswerByQuestionIndex(n) || r && this.questions[n] === this.questions[r];)n += 1;
                if (n < (r || this.questions.length))return n;
                for (; !(n < (r || this.questions.length)) || this.findAnswerByQuestionIndex(n) || r && this.questions[n] === this.questions[r] || o && this.questions[n] === this.questions[o];)n -= 1;
                if (n > 0)return n;
                throw"imposible to go on"
            },
            calculateListenableUpperContour: function () {
                var e, t, n, r;
                for (e = null, t = this.questions.length - 1; ;) {
                    if ((null != (n = this.findAnswerByQuestionIndex(t)) ? n.correct : void 0) && (null != (r = this.findAnswerByQuestionIndex(t - 1)) ? r.correct : void 0)) {
                        e = t;
                        break
                    }
                    if (t -= 1, 0 >= t)break
            ...
            calculateIllistenableLowerContour: function () {
                var e, t, n, r, i, o;
                for (n = null, i = this.questions.length - 1; ;) {
                    if (e = this.findAnswerByQuestionIndex(i), t = this.findAnswerByQuestionIndex(i - 1), e && !e.correct && t && !t.correct) {
                        n = i;
                        break
                    }
                    if (i -= 1, 0 >= i)break
                }
                if (o = this.calculateListenableUpperContour()) {
                    for (r = !1, i = o + 1; i < this.questions.length;) {
                        if (null === this.findAnswerByQuestionIndex(i)) {
                            r = !0;
                            break
                        }
                        i += 1
                    }
                    r === !1 && (n = this.questions.length)
                }
                return this.declaredIllistenableLowerContour && (null === n ? n = this.declaredIllistenableLowerContour : this.declaredIllistenableLowerContour < n && (n = this.declaredIllistenableLowerContour)), n
            }
        }, r.next()
    })
}.call(this), function () {
    $(function () {
        return eum.retina_images(), "undefined" != typeof wx && null !== wx && wx.config({
            debug: !1,
            appId: eum.config.appid,
            timestamp: eum.config.ts,
            nonceStr: eum.config.nonce,
            signature: eum.config.signature,
            jsApiList: ["onMenuShareTimeline", "onMenuShareAppMessage"]
        }), "undefined" != typeof wx && null !== wx && wx.ready(function () {
            return wx.onMenuShareTimeline({
                title: gon.moment_title,
                link: gon.moment_uri,
                imgUrl: gon.moment_icon
            }), wx.onMenuShareAppMessage({title: gon.moment_title, link: gon.moment_uri, imgUrl: gon.moment_icon})
        }), $(document).trigger("page:load#" + gon.pageId, [$("#" + gon.pageId)])
    }), this.eum = {
        retina: function () {
            var e;
            return window.devicePixelRatio > 1 ? window.devicePixelRatio : (e = ["(-webkit-min-device-pixel-ratio: 1.5)", "(min--moz-device-pixel-ratio: 1.5)", "(-o-min-device-pixel-ratio: 3/2)", "(min-resolution: 1.5dppx)"].join(", "), window.matchMedia && window.matchMedia(e).matches ? 2 : !1)
        }, retina_images: function (e) {
            var t;
            return null == e && (e = $("img[data-at2x]")), (t = eum.retina()) ? e.each(function () {
                var e, n;
                return e = $(this), n = e.data("at" + t + "x"), n ? e.attr("src", n) : void 0
            }) : void 0
        }
    }
}.call(this);